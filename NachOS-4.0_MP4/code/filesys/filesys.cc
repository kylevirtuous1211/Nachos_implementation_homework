...
bool FileSystem::Create(char *name, int initialSize)
{
    ...
    if (directory->Find(name) != -1) {
        ...
        DEBUG(dbgFile, "File already exists in directory");
    } else {
    ...
    delete directory;
    DEBUG(dbgFile, "CREATE COMPLETE");
    return success;
}

//----------------------------------------------------------------------
// FileSystem::OpenAsOpenFile
// 	Open a file for reading and writing as openfile.
//	To open a file:
...
OpenFile * FileSystem::OpenAsOpenFile(char *name)
{
    Directory *directory = new Directory(NumDirEntries);
