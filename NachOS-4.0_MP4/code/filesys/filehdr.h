...
#include "disk.h"
#include "pbitmap.h"
//add one more space for a new pointer(nextFileHeader)
...
public:
	...
	int CountFileHeaders(); // Return the number of file headers connected to this file header
...
private:
	...
	*/
	FileHeader* nextFileHeader; // Pointer to the next file header
	...
	void PrintContent();
	void PrintBlock();
	int nextFileHeaderSector;   // Disk sector number of the next file header
};
